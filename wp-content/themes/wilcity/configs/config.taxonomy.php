...
//		array(
//			'type'          => 'timezone',
//			'name'          => esc_html__('Location Timezone', 'wilcity'),
//			'description'   => esc_html__('Enter your timezone in the input field, You can also find your timezone by using the select suggestion field. This setting is useful to detect whether a resaturent, a bar is closed or opening. Leave empty to use the default settings in Settings -> General.', 'wilcity'),
//			'id'            => 'timezone'
//		),
		array(
			'type'          => 'text',
