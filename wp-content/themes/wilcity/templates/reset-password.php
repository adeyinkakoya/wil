                                ...
                                <div class="wil-tb__cell">
									...
									if ( is_user_logged_in() ):
										...
										if ( isset($_GET['action']) && $_GET['action'] == 'rp' ){
											...
											if ( !isset( $_GET['key'] ) ) {
												?>
                                                <wiloke-message :status="msgStatus" :msg="msg"></wiloke-message>
                                                <div v-show="!hideForm">
                                                    <form action="#" @submit.prevent="updatePassword">
                                                        ...
                                                        <input type="hidden" id="wilcity-rp-key"
                                                               value="<?php echo esc_attr( $rp_key ); ?>">
                                            ...
                                            <div v-show="!hideForm">
												...
												if ( ( isset($_GET['action']) && $_GET['action'] == 'lostpassword' )  ) {
													WilokeMessage::message( array(
														'msg'    => esc_html__( 'Your password reset link appears to be invalid or expiry. Please request a new link below.', 'wilcity' ),
														'status' => 'danger'
													) );
												}else{
													WilokeMessage::message( array(
