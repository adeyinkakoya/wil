...
<div class="content-box_module__333d9">
	...
	<div class="content-box_body__3tSRB">
		<div class="row">
            ...
            <wiloke-single-compare-views :wrapper-class="'col-xs-6 col-sm-6 col-md-3 col-lg-3'" :place-holder-text="'<?php echo esc_attr__('View', 'wilcity'); ?>'"></wiloke-single-compare-views>
            <wiloke-single-compare-favorites :wrapper-class="'col-xs-6 col-sm-6 col-md-3 col-lg-3'" :place-holder-text="'<?php echo esc_attr__('Favorites', 'wilcity'); ?>'"></wiloke-single-compare-favorites>
            <wiloke-single-compare-shares :wrapper-class="'col-xs-6 col-sm-6 col-md-3 col-lg-3'" :place-holder-text="'<?php echo esc_attr__('Shares', 'wilcity'); ?>'"></wiloke-single-compare-shares>
		...
		<div class="promo-item-2_module__2mwrO">
			...
			<div class="promo-item-2_action__Gnojf">
				<a class="wilcity-temporary-disable wil-btn wil-btn--primary wil-btn--sm wil-btn--round disable" @click.prevent="onOpenPromotionPopup('<?php echo esc_attr($post->ID); ?>')" href="#"><?php esc_html_e('Promote Listing', 'wilcity'); ?></a>
			</div>
