...
<div class="comment-review_module__-Z5tr wilcity-review-item-<?php echo esc_attr($wilcityoReview->ID); ?>">
    ...
    <div class="comment-review_body__qhUqq">
        <div class="comment-review_content__1jFfZ">
            ...
            <div class="wilcity-review-content-<?php echo esc_attr($wilcityoReview->ID); ?>"><?php Wiloke::ksesHTML(nl2br($wilcityoReview->post_content)); ?></div>
        </div>
		<?php
        ...
        <div class="comment-review_meta__1chzm">
            <span class="wilcity-count-liked-<?php echo esc_attr($wilcityoReview->ID); ?>"><?php echo esc_html(ReviewController::countLiked($wilcityoReview->ID) . ' ' . $wiloke->aConfigs['translation']['liked']); ?></span>
