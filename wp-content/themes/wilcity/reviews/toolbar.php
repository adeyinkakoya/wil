...
<div class="dropdown_module__J_Zpj ml-20">
	...
	<div class="dropdown_itemsWrap__2fuze" data-toggle-content="dropdown">
		...
		<ul class="list_module__1eis9 list-none list_small__3fRoS list_abs__OP7Og arrow--top-right wilcity-review-toolbar-wrapper" data-id="<?php echo esc_attr($wilcityoReview->ID); ?>">
			...
			<li class="list_item__3YghP">
                <wiloke-report-popup-btn wrapper-class="list_link__2rDA1 text-ellipsis color-primary--hover" target-id="<?php echo esc_attr($wilcityoReview->ID); ?>">
                ...
                </wiloke-report-popup-btn>
            </li>
            <?php endif; ?>

			<?php if (  WilokeUser::isPostAuthor($wilcityoReview, false) && ( isset($wilcityParentPost->post_type) && $wilcityParentPost->post_type != 'event') ) : ?>
			<li class="list_item__3YghP">
                <wiloke-review-popup-btn v-on:on-open-review-popup="onOpenReviewPopup" review-id="<?php echo esc_attr($post->ID); ?>" btn-name="<?php echo esc_attr__('Edit Review', 'wilcity'); ?>" icon="la la-edit" wrapper-class="list_link__2rDA1 text-ellipsis color-primary--hover wilcity-edit-review wilcity-edit-review-<?php echo esc_attr($wilcityoReview->ID); ?>"></wiloke-review-popup-btn>
            </li>
            <?php endif; ?>
