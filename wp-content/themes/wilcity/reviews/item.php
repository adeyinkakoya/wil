...
?>
<div class="comment-review_module__-Z5tr wilcity-js-review-item-<?php echo esc_attr($wilcityoReview->ID); ?>">
    <div class="comment-review_header__1si3M">
        <div class="utility-box-1_module__MYXpX utility-box-1_boxLeft__3iS6b clearfix utility-box-1_sm__mopok  review-author-avatar">
            <div class="utility-box-1_avatar__DB9c_ rounded-circle" style="background-image: url('<?php echo esc_url(User::getAvatar($wilcityoReview->post_author)); ?>');">
    ...
    <div class="comment-review_body__qhUqq">
        <div class="comment-review_content__1jFfZ">
			...
			<?php endif; ?>
            <div class="wilcity-review-content-<?php echo esc_attr($wilcityoReview->ID); ?>"><?php Wiloke::ksesHTML(wpautop($wilcityoReview->post_content)); ?></div>
        </div>
		<?php
        ...
        <div class="comment-review_meta__1chzm">
            <span data-count-liked="<?php echo esc_attr(ReviewController::countLiked($wilcityoReview->ID)); ?>" class="wilcity-count-liked-<?php echo esc_attr($wilcityoReview->ID); ?>"><?php echo esc_html(ReviewController::countLiked($wilcityoReview->ID) . ' ' . $wiloke->aConfigs['translation']['liked']); ?></span>
			<?php ReviewController::countDiscussion($wilcityoReview->ID); ?>
