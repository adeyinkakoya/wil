...
?>
    <div id="wilcity-root" class="wil-content">
            ...
            <div class="container">
                <?php while( have_posts() ) : the_post(); ?>
                        ...
                        <div id="wilcity-our-bank-account">
                            <div class="promo-item_module__24ZhT mb-15">
                                <div class="promo-item_group__2ZJhC">
                                    <h3 class="promo-item_title__3hfHG"><?php esc_html_e('Our bank details', 'wilcity'); ?></h3>
                                </div>
                            </div>
                    ...
                    <div class="table-module">
                        <?php
                        $aColumnTitles = array(esc_html__('Plan Name', 'wilcity'), esc_html__('Sub Total', 'wilcity'), esc_html__('Discount', 'wilcity'), esc_html__('Total', 'wilcity'));
                        ...
                        if ( !GetWilokeSubmission::isNonRecurringPayment() && !empty($aPlanSettings['trial_period']) ){
	                        $aColumnTitles[] = esc_html__('Trial Period (Days)', 'wilcity');
