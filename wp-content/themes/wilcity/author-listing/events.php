...
$gridID = uniqid('wilcity_grid_');
?>

<div id="<?php echo esc_attr($gridID); ?>" class="row js-listing-grid">
	<?php
	if ( !function_exists('wilcity_render_event_item') ){
