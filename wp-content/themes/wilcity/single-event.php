...
get_header();
global $wilcityReviewConfiguration;

if ( have_posts() ) {
	while ( have_posts() ) {
		the_post();

		$sidebarPos = isset($aGeneralListingSettings['single_event_sidebar']) ? isset($aGeneralListingSettings['single_event_sidebar']) : 'right';
		...
		<div id="wilcity-single-event-wrapper">
            ...
            <?php do_action('wilcity/single-event/wil-content', $post); ?>
		</div>
		<?php
	}
}
