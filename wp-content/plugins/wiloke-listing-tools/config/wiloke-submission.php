	...
	'configuration' => array(
		'fields' => array(
			...
			array(
				...
				'desc_status'=>'red',
				'desc'=>'To setup a Package page, please follow this instruction: From the admin sidebar, click on Pages -> Add New -> Set this page to Wilcity Package Page template. Next, click on Add New shortcode -> Navigate to Wilcity tab -> Select Pricing Table shortcode and set Post Type to Depends on Listing Type Request',
