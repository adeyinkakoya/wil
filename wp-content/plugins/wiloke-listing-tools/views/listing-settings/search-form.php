<div data-tab="search-form" class="ui bottom attached tab segment">
    ...
    <div class="ui warning message">
        <p>Warning: Type(select2) is a required Field</p>
    </div>

    <div class="ui info message">
        <p>Refer to <a href="https://documentation.wilcity.com/knowledgebase/setting-up-the-main-search-form/" target="_blank">Documentation</a> or Open a topic on <a href="https://wilcity.ticksy.com/" target="_blank">wilcity.ticksy.com</a></p>
    </div>
								...
								<div :class="dragFormClass(oUsedField)">
									...
									<div class="dragArea__form-content hidden">
                                        ...
                                        <div v-if="oUsedField.group=='term'">
                                            <div v-if="oUsedField.term !== 'listing_tag'" class="ui setting-field field">
                                                <label>Is Ajax?</label>
                                        ...
                                        <div v-else-if="oUsedField.key=='google_place'">
                                            <div class="ui setting-field field">
                                                <label>Radius Label</label>
                                                <input type="text" v-model="oUsedField.radiusLabel">
                                            </div>
                                            <div class="ui setting-field field">
                                                <label>Max Radius</label>
                                                <input type="text" v-model="oUsedField.maxRadius">
                                            </div>

                                            <div class="ui setting-field field">
                                                <label>Default Radius</label>
                                                <input type="text" v-model="oUsedField.defaultRadius">
                                            </div>

                                            <div class="ui setting-field field">
                                                <label>Default Radius</label>
                                                <select v-model="oUsedField.unit">
                                        ...
                                        <div v-else-if="oUsedField.key == 'date_range'">
                                            <div class="ui field">
