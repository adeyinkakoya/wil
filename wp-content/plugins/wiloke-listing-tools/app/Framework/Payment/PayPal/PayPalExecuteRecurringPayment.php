...
class PayPalExecuteRecurringPayment{
	...
	public function executePayment(){
		if ( !$this->isMatchedToken() || GetWilokeSubmission::isCancelPage() ){
			return false;
		}
		...
		try{
			...
			PaymentMetaModel::set($this->paymentID, wilokeListingToolsRepository()->get('payment:paymentInfo'), $oResult);
			...
			PaymentMetaModel::set($this->paymentID, wilokeListingToolsRepository()->get('addlisting:paypalAgreementID'), $oResult->id);
