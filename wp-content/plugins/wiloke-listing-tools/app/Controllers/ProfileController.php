...
class ProfileController extends Controller {
	...
	public static function updatePassword($aPassword, $userID){
		...
		wp_set_password( $aPassword['newPassword'], $userID );
	...
	public static function fetchProfileFields(){
		...
		$aBasicInfo['send_email_if_reply_message']  = array(
			...
			'type'  => 'checkbox',
			'label' => esc_html__('Send an email if I receive a message from admin', 'wiloke-listing-tools')
		);
		...
		$aFollowContact['website'] = array(
			'type' => 'input',
			'value'=> GetSettings::getUserMeta($userID, 'website'),
