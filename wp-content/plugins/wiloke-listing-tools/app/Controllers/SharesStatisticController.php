...
class SharesStatisticController extends Controller {
	...
	public function __construct() {
		...
		add_action('wp_ajax_wilcity_fetch_compare_shares', array($this, 'fetchComparison'));
	}

	public function fetchComparison(){
		$aComparison  = self::compare(get_post_field('post_author', $_POST['postID']), $_POST['postID']);
		...
		wp_send_json_success($aComparison);
	}
