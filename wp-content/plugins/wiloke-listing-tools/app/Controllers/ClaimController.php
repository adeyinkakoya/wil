...
//		add_action('wp_enqueue_scripts', array($this, 'enqueueScripts'));
		...
		add_action('wp_ajax_wilcity_get_claim_fields', array($this, 'fetchClaimFields'));
		add_action('wp_ajax_nopriv_wilcity_get_claim_fields', array($this, 'fetchClaimFields'));
	}
	...
	public function approvedClaimListing($metaID, $objectID, $metaKey, $metaValue){
        ...
        do_action('wiloke/claim/approved', $claimerID, $this->listingID);
	...
	public function handleClaimRequest(){
		...
		$this->planID = $aData['claimPackage'];
        $this->claimerID = get_current_user_id();
	...
	public function fetchClaimFields(){
		...
		wp_send_json_success($aClaimSettings);
    }
