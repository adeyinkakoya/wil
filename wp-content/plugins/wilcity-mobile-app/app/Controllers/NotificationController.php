...
class NotificationController extends JsonSkeleton {
	use VerifyToken;
	use ParsePost;
	...
	public function getMyNotifications(){
		...
		if ( !$aNotifications ){
			...
			foreach ($aNotifications['aResults'] as $oInfo){
				...
				if ( $aNotification ){
					if ( isset($aNotification['isNoLogger']) ) {
						continue;
					}
					...
					$aNotification['postContent'] = (isset($aNotification['title']) ? $aNotification['title'] : '') . ' ' . $aNotification['content'] . ( isset($aNotification['contentHighlight']) ? ' ' . $aNotification['contentHighlight'] : '' );
