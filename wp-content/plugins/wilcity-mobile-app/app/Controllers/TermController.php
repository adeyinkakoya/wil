...
class TermController extends JsonSkeleton{
	public function __construct() {
		add_action( 'rest_api_init', function () {
			...
			register_rest_route( WILOKE_PREFIX.'/v2', '/listing-location/(?P<slug>\w+)', array(
				'methods' => 'GET',
				'callback' => array($this, 'getListingsInLocation'),
			));

			register_rest_route( WILOKE_PREFIX.'/v2', '/listing-category/(?P<id>\d+)', array(
				'methods' => 'GET',
				'callback' => array($this, 'getListingsInCat'),
			));

			register_rest_route( WILOKE_PREFIX.'/v2', '/listing-category/(?P<slug>\w+)', array(
				'methods' => 'GET',
				'callback' => array($this, 'getListingsInCat'),
			));
			...
			register_rest_route( WILOKE_PREFIX.'/v2', '/listing_tag/(?P<slug>\w+)', array(
				'methods' => 'GET',
				'callback' => array($this, 'getListingTag'),
			));
		} );
