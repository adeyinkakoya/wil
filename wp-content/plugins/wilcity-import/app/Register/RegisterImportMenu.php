...
//			array(
//				'msg'   => 'The menu has been setup successfully.'
//			)
//		);
	}
	...
	public function runSetup(){
		...
		if ( $_POST['mode'] == 'homes' ){
			$status = false;
			if ( $_POST['pagebuilder'] == 'kc' ){
				$status = $this->importKC();
			}else if ( $_POST['pagebuilder'] == 'elementor' ){
		...
		<div id="wiloke-submission-wrapper">
			...
			<div class="ui bottom attached active tab segment" data-tab="setup">
				...
				<div class="ui segment">
					...
					<p class="message ui warning"><?php esc_html_e('Before importing demo, we highly recommend increasing upload_max_filesize, post_max_size to 80Mb: Log into your hosting -> Looking for PHP configuration. You can reset to default after that.', 'wiloke'); ?></p>
