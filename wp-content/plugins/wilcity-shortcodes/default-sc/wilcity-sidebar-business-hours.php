                ...
                foreach ($aBusinessHours as $aDayInfo) :
                    if ( $aDayInfo['isOpen'] == 'no' ):
                        ...
                        <li class="<?php echo esc_attr($wrapperClass); ?>"><span class="listing-hours_day__2Opo_"><?php echo esc_html($aDefineDaysOfWeek[$aDayInfo['dayOfWeek']]); ?></span>
                            <div class="listing-hours_hour__1OuD9">
                                <span class="listing-hours_houritem__3cCSp"><?php echo WilcityTimeHelper::renderTime($aDayInfo['firstOpenHour'], $timeFormat); ?> - <?php echo WilcityTimeHelper::renderTime($aDayInfo['firstCloseHour'], $timeFormat); ?></span>
			                    <?php if ( BusinessHours::isSecondHourExists($aDayInfo) ) : ?>
                                    <span class="listing-hours_houritem__3cCSp"><?php echo WilcityTimeHelper::renderTime($aDayInfo['secondOpenHour'], $timeFormat); ?> - <?php echo WilcityTimeHelper::renderTime($aDayInfo['secondCloseHour'], $timeFormat); ?></span>
			                    <?php endif; ?>
                            </div>
                        </li>
                    <?php endif; ?>
