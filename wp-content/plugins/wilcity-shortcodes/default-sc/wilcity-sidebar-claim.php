		...
		<div class="content-box_body__3tSRB">
			<div class="promo-item_module__24ZhT">
				<div class="promo-item_group__2ZJhC">
					...
					<p class="promo-item_description__2nc26"><?php echo esc_html($aAtts['boxDesc']); ?></p>
				</div>
				<div class="promo-item_action__pd8hZ">
                    <wiloke-claim-popup-btn target-id="<?php echo esc_attr($post->ID); ?>"><template slot="insideBtn"><?php esc_html_e('Claim Now', 'wilcity-shortcodes'); ?></template></wiloke-claim-popup-btn>
				</div>
			</div>
		</div>
	</div>
