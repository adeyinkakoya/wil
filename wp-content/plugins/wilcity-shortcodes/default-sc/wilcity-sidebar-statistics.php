				...
				<div class="col-sm-6 col-sm-6-clear">
					<div class="icon-box-1_module__uyg5F two-text-ellipsis mt-20 mt-sm-15">
						<div class="icon-box-1_block1__bJ25J">
							...
							<div class="icon-box-1_text__3R39g"><?php echo empty($totalFavorites) ? $totalFavorites . ' ' . esc_html__('Favorite', 'wilcity-shortcodes') : sprintf(_n('%d Favorite', '%d Favorites', $totalFavorites,  'wilcity-shortcodes'), $totalFavorites); ?></div>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-sm-6-clear">
