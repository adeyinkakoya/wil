	...
	<div class="content-box_module__333d9">
		...
		<div class="content-box_body__3tSRB">
			<div class="price-range_module__348HY clearfix">
				<div class="price-range_sign__3thLa"><i class="<?php echo esc_attr($aAtts['currencyIcon']); ?>"></i></div>
				<div class="price-range_group__23kMb">
					<div class="price-range_range__19Fut color-primary">
						<div class="price-range_from__3iV-6"><sup class="price-range_supSig__1pMDY <?php echo esc_attr($currencyPos); ?>"><?php echo esc_attr($currencySymbol); ?></sup><?php echo esc_html($price); ?></div>
					</div>
				</div>
			</div>
		</div>
