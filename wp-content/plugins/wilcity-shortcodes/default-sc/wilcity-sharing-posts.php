...
function wilcitySharingPosts($aAtts){
	...
	if ( $aAtts['style'] == 'list' ) :
	?>
	<ul data-postid="<?php echo esc_attr($aAtts['post_id']); ?>" class="wilcity-social-sharing-wrapper list_module__1eis9 list-none list_social__31Q0V list_medium__1aT2c list_abs__OP7Og arrow--top-right">
        <?php
        ...
        ?>
            <li class="list_item__3YghP">
                <a target="_blank" class="wilcity-social-sharing list_link__2rDA1 text-ellipsis color-primary--hover" href="<?php echo esc_url($aSocialLink[$socialKey]) ?>"><span class="list_icon__2YpTp"><i class="fa fa-<?php echo esc_attr($socialKey); ?>"></i></span><span class="list_text__35R07"><?php echo $socialName; ?></span></a>
            </li>
        <?php endforeach; ?>
		<li class="list_item__3YghP">
			<a class="wilcity-social-sharing list_link__2rDA1 text-ellipsis color-primary--hover" href="mailto:?Subject=<?php echo str_replace(' ', '%20', $title); ?>&Body=<?php echo esc_url($link); ?>"><span class="list_icon__2YpTp"><i class="fa fa-envelope"></i></span><span class="list_text__35R07">Email</span></a>
		</li>
		<li class="list_item__3YghP"><a class="wilcity-copy-link wilcity-social-sharing list_link__2rDA1 text-ellipsis color-primary--hover" href="#" data-shortlink="<?php echo esc_url($link); ?>" data-desc="<?php esc_html_e('Press Ctrl+C to copy this link', 'wilcity-shortcodes'); ?>"><span class="list_icon__2YpTp"><i class="fa fa-link"></i></span><span class="list_text__35R07"><?php esc_html_e('Copy link', 'wilcity-shortcodes'); ?></span></a></li>
	</ul>
	<?php
    else:
    ?>
