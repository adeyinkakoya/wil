            ...
            <div class="highlight-lava-js">
				...
				if ( $aAtts['orderby'] == 'specify_terms' ) {
					...
					foreach ( $aTermIds as $termID ) {
						$oTerm = GetSettings::getTermBy( 'term_id', $termID, $aAtts['taxonomy'] );
    ...
    <?php endif; ?>
        <?php if ( $aAtts['bg_type'] == 'image' ) : ?>
            <div class="hero_background__xrTbV">
                ...
                <?php endif; ?>
                <div class="hero_img__3VbXk bg-cover" style="background-image: url(<?php echo esc_url($aAtts['image_bg']); ?>);"></div>
            </div>
        <?php else: ?>
            ...
            <div class="hero_background__xrTbV">
                ...
                <div class="swiper__module swiper-container" data-options='{"slidesPerView":1,"effect":"fade","autoplay":{"delay":5000}}'>
                    <div class="swiper-wrapper">
                        <?php foreach ($aAtts['slider_bg'] as $imgID) : ?>
                ...
                <div class="hero_container__9jNUX wil-text-center">
                    <div class="hero_textWrapper__aU40s">
                        <?php if ( !empty($aAtts['heading_color']) ) : ?>
                            <h1 style="color: <?php echo esc_attr($aAtts['heading_color']); ?>; font-size: <?php echo esc_attr($aAtts['heading_font_size']); ?>" class="hero_title__47he3"><?php echo esc_html($aAtts['heading']); ?></h1>
                        <?php else : ?>
                            <h1 style="font-size: <?php echo esc_attr($aAtts['heading_font_size']); ?>" class="hero_title__47he3 color-primary"><?php echo esc_html($aAtts['heading']); ?></h1>
                        <?php endif; ?>

                        <?php if ( !empty($aAtts['description_color']) ) : ?>
                            <div class="hero_text__3ENGw" style="color: <?php echo esc_attr($aAtts['description_color']); ?>; font-size: <?php echo esc_attr($aAtts['description_font_size']); ?>"><?php echo esc_html($aAtts['description']); ?></div>
                        <?php else: ?>
                            <div class="hero_text__3ENGw" style="font-size: <?php echo esc_attr($aAtts['description_font_size']); ?>"><?php echo esc_html($aAtts['description']); ?></div>
                        <?php endif; ?>
                        ...
                        <div class="mb-30 pb-20">
                            ...
                            <?php endif; ?>
                            <?php if( !empty($aAtts['button_icon']) ) : ?><i class="<?php echo esc_attr($aAtts['button_icon']); ?>"></i><?php endif; ?> <?php echo esc_html($aAtts['button_name']); ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
	                <?php
