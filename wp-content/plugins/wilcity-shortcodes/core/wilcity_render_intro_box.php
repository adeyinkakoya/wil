	...
	<div class="col-md-6 col-lg-6 ">
		...
		<div class="video-popup_module__2P6ZG video-popup_round__2d8uy  video-popup-parallax-inner" data-hover-parallax-options="3d">
			<div class="video-popup_media__dEwwq">
				...
				<div class="video-popup_img__3zV5d bg-cover" style="background-image: url('<?php echo esc_url($aAtts['bg_img']); ?>')"></div><a class="video-popup_popup__17b-F js-video-popup" href="<?php echo esc_url($aAtts['video_intro']); ?>"><i class="la la-play"></i></a>
			</div>
