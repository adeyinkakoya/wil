...
class ListingPromotionOnListingCategorySidebar extends \WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wilcity_promote_listings_on_category', WILCITY_WIDGET . ' (Promotion) Category');
	}
	...
	public function widget( $aAtts, $aInstance ) {
		...
		$aArgs = array(
			...
			'post_status'       => 'publish',
			'meta_key'          => 'wilcity_promote_listing_category_sidebar',
