...
class ListingPromotionOnBlogSidebar extends \WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wilcity_promote_listings_on_blog', WILCITY_WIDGET . ' (Promotion) Blog');
	}
	...
	public function widget( $aAtts, $aInstance ) {
		...
		$aArgs = array(
			...
			'post_status'       => 'publish',
			'meta_key'          => 'wilcity_promote_blog_sidebar',
