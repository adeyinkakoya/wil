...
class ListingPromotionOnSinglePostSidebar extends \WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wilcity_promote_listings_on_single_post', WILCITY_WIDGET . ' (Promotion) Single Post');
	}
	...
	public function widget( $aAtts, $aInstance ) {
		...
		$aArgs = array(
			...
			'post_status'       => 'publish',
			'meta_key'          => 'wilcity_promote_single_post_sidebar',
